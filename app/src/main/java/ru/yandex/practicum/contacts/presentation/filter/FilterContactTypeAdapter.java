...
public class FilterContactTypeAdapter extends RecyclerView.Adapter<FilterContactTypeAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<FilterContactTypeUi> differ = new AsyncListDiffer<>(
            ...
            new AsyncDifferConfig.Builder<>(new BaseListDiffCallback<FilterContactTypeUi>()).build() // замена экземпляра класса ListDiffCallback на BaseListDiffCallback<>, с указанием имени класса
    );
    ...
    }*/ // ПОКА РЕШИЛ ЗАКОММЕНТИРОВАТЬ ДАННЫЙ КЛАСС, А НЕ УДАЛЯТЬ
}
