...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<ContactUi> differ = new AsyncListDiffer<>(
            ...
            new AsyncDifferConfig.Builder<>(new BaseListDiffCallback<ContactUi>()).build() // замена экземпляра класса ListDiffCallback на BaseListDiffCallback<>, с указанием имени класса
    );
