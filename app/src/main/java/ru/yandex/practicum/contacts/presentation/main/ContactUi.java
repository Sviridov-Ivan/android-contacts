...
public class ContactUi implements ListDiffInterface<ContactUi> { //имплементация интерфейса ListDiffInterface
    ...
    @Override
    public boolean theSameAs(ContactUi other) { //реализация метода theSameAs(), согласно задания в Шаге №2;
