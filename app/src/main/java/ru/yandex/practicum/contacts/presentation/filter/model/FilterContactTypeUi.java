...
public class FilterContactTypeUi implements ListDiffInterface<FilterContactTypeUi> { //имплементация интерфейса ListDiffInterface
    ...
    @Override
    public boolean theSameAs(FilterContactTypeUi other) { //реализация метода theSameAs(), согласно задания в Шаге №2;
