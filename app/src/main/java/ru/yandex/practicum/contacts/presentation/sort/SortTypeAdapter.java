...
public class SortTypeAdapter extends RecyclerView.Adapter<SortTypeAdapter.ViewHolder> {
    ...
    private final AsyncListDiffer<SortTypeUI> differ = new AsyncListDiffer<>(
            ...
            new AsyncDifferConfig.Builder<>(new BaseListDiffCallback<SortTypeUI>()).build() // замена экземпляра класса ListDiffCallback на BaseListDiffCallback<>, с указанием имени класса
    );
